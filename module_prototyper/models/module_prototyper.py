...
class ModulePrototyper(models.Model):
    ...
    def generate_models_details(self):
        ...
        for field in field_descriptions.values():
        ...
        for model, custom_fields in relations.items():
    ...
    def generate_views_details(self):
        ...
        views_details = []
        for model, views in relations.items():
    ...
    def generate_menus_details(self):
        ...
        menus_details = []
        for model_name, menus in relations.items():
